...
export default function Page() {
  return (
    <main className="container mx-auto px-4 py-10">
      <h1 className="text-3xl font-serif mb-4">{`Fixed Braces`}</h1>
      <p className="opacity-70">This is a scaffold page for <strong>{`/treatments/orthodontics/fixed-braces`}</strong>.
